...
function print_help() {
    echo "" && \
    echo "PrepareSherpaLibs version 2.1" && echo && \
...
INSTTEMPLATE="SetupSherpaInterface_new.sh"                    # name of template file for setup script
